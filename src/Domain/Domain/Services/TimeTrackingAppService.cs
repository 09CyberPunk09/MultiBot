...
{
    private readonly IRepository<TimeTrackingActivity> _activityRepo;
    private readonly IRepository<TimeTrackingEntry> _entryRepo;
    private readonly IRepository<User> _userRepo;
    public TimeTrackingAppService(
        IRepository<TimeTrackingActivity> repo,
        IRepository<TimeTrackingEntry> entryRepo,
