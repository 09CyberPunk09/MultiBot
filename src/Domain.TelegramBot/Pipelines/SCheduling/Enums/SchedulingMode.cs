...
namespace Application.TelegramBot.Pipelines.Old.MessagePipelines.Scheduling.Enums
{
    public class SchedulingMode : SmartEnum<SchedulingMode>
    {
        ...
        */
        ...
        public static readonly SchedulingMode TodayAt = new(8, "Today at [time(s)]", false);
        public static readonly SchedulingMode TomorrowAt = new(9, "Tomorrow at [time(s)]", false);
        ...
        public static readonly SchedulingMode OnDATEAT = new(4, "On [date] at [time(s)]", false);
        ...
        public SchedulingMode(int value, string name,bool recurent = true, string example = "") : base(name, value)
        {
            Example = example;
            Recurent= recurent;
        }

        public bool Recurent { get; set; }
