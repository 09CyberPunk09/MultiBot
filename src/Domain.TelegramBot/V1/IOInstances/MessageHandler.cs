...
namespace Application.TelegramBot.Pipelines.Old.IOInstances
{
    public class MessageHandler
    {
        ...
        public Task ConsumeMessage(TelegramMessage message)
        {
        ...
        private void ExecutePieplineStage(MessagePipelineBase pipeline, TelegramMessage message, bool firstTimePerCommand = false)
        {
            if (pipeline != null)
            {
