...
namespace Application.TelegramBot.Pipelines.Old.MessagePipelines.Scheduling.Enums
{
    public class SchedulingMode : SmartEnum<SchedulingMode>
    {
        ...
        */
        ...
        //TODO: Implement Pipeline execution context
        ...
        public static readonly SchedulingMode EveryNTHDAYStartingFromTodayAT = new(5, "Every [N]th day starting from today [time]");
